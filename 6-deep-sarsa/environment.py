...
class Env(tk.Tk):
    ...
    def load_images(self):
        rectangle = PhotoImage(
            Image.open(r"C:\Users\moonstar\Desktop\Python\RL\1-grid-world\image\rectangle.png").resize((30, 30)))
        triangle = PhotoImage(
            Image.open(r"C:\Users\moonstar\Desktop\Python\RL\1-grid-world\image\triangle.png").resize((30, 30)))
        circle = PhotoImage(
            Image.open(r"C:\Users\moonstar\Desktop\Python\RL\1-grid-world\image\circle.png").resize((30, 30)))
